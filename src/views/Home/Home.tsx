...
const rows = [
  createData(1, 'Termonoseque', 'HP', 787542, 'googleshopping-logo.png'),
  createData(2, 'La kuka', 'Siemens', 6000000, 'mercadolibre-logo.png'),
  createData(3, 'Termica', 'Manaos', 4568, 'magento-logo.png'),
  createData(4, 'Cosa rara', 'Microsft', 5635, 'googleshopping-logo.png'),
  createData(5, 'Aparato', 'Apple', 1, 'tiendanube-logo.png'),
  createData(6, 'Otro aparato', 'Siemens', 5742, 'tiendanube-logo.png'),
  createData(7, 'Transformador', 'Dell', 8522, 'mercadolibre-logo.png'),
  createData(8, 'Termotanque', 'Samsung', 1755, 'magento-logo.png')
]
